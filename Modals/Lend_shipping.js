...
import {confirm, lenderShip, nextSteps, steps} from '../Constants/Keywords';
import FAQsComponent from './FaqComponent';

const LendShipping = ({modalVisible, setModalVisible}) => {
  return (
    <ScrollView
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.description}>
          <Text style={styles.normalText}>
            {lenderShip.shipped}
            <Text style={styles.boldText}>{lenderShip.email}</Text>
            {''}
            <Text style={styles.normalText}>{lenderShip.details}</Text>
          </Text>
        </View>
        <TouchableOpacity
          style={styles.Btn}
