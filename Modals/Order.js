...
const Order = ({modalVisible, setModalVisible}) => {
  return (
    <View style={styles.mainContainer}>
      <View style={{margin: 20}}>
        <Text style={styles.paymentHeader}>Order placed Successfully</Text>
      </View>
      <View style={styles.imageContainer}>
        <Image
          style={{marginLeft: 20, alignSelf: 'flex-start'}}
          source={AppImages.placedPic.place}
        />
      </View>
      ...
      <View style={{margin: 5, gap: 5}}>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.browseBtnText}>Browse more</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
